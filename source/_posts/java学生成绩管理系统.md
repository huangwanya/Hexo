...
class Student
{
    ...
    public void menu() throws IOException  //将异常抛出，调用这个方法去处理异常,如果main方法也将异常抛出，则交给Java虚拟机来处理,下同.
    {
        ...
        switch(a)
        {
            case 1:this.add();break;  //添加
            case 2:this.show();break;  //显示
            case 3:this.modif();break;  //修改
            case 4:this.delete();break;  //删除
            case 5:this.look();break;  //查看
